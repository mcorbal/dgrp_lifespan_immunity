...
## Deciding how to handle Flies stuck to food - Line 897
...
```{r quick plot survcurv, warning=F, message=F, fig.cap="Surv curv of Line 897 with food-stuck flies censored, but counts of which juxtaposed on seccond y-axis"}
...
```{r 897 food-stuck included, warning=F,message=F, fig.cap="Surv curv of Line 897 with food-stuck included as deaths"}
data_include_stuck <-
  data_long %>% 
  separate(5, c("Sex", "Event")) %>% 
  mutate(Event = recode(Event, 
...
```{r quick plot 287 survcurv, warning=F, fig.cap="Surv curv of Line 287 with food-stuck flies censored, but counts of which juxtaposed on seccond y-axis"}
...
```{r line 287 included,message=F, fig.cap="Surv curv of Line 287 with food-stuck included as deaths"}
